<script>
      ...
      <div class="flex justify-between items-center">
          ...
          <div class="card w-96 bg-base-100 shadow">
              <div class="card-body">
                  ...
                  <p class="text-2xl font-bold">$100/hour</p>
  ...
  <div class="carousel w-full mt-10">
          ...
          <div class="card-bordered w-full bg-base-100 shadow">
            <div class="card-body flex flex-row items-center">
              <div class="flex-1">
                ...
                <p>We install camera systems!</p>
                <p>$300/ camera</p>
                <p>Takes 1 hour/Camera</p>
    ...
    <h1 class="font-bold text-4xl mt-10">Time Based Services</h1>
  <div class="carousel w-full mt-10">
        ...
        <div class="card-bordered w-full bg-base-100 shadow">
            <div class="card-body flex flex-row items-center">
              <div class="flex-1">
                ...
                <p>Typically: 20 Minutes/Light</p>
              </div>
              <!--
                {#if imageLoaded[1]}
  ...
  <div id="slide1" class="carousel-item ml-3 relative w-1/3 snap-start">
    ...
    <div id="slide4" class="carousel-item ml-3 relative w-1/3 snap-start">
      <div class="card-bordered w-full bg-base-100 shadow">
        <div class="card-body flex flex-row items-center">
          <div class="flex-1">
            <h2 class="card-title">A New Thermostat Wire</h2>
            <p>We can pull a new thermostat wire to ensure your HVAC system operates efficiently.</p>
            <p>Typically: 2 hours</p>
          </div>
          <!--
          {#if imageLoaded[3]}
            <img src={images[3].src} alt={images[3].alt} width={images[3].width} height={images[3].height} class="ml-4" />
          {/if}
          -->
        </div>
      </div>
    ...
    <div id="slide5" class="carousel-item ml-3 relative w-1/3 snap-start">
      <div class="card-bordered w-full bg-base-100 shadow">
        <div class="card-body flex flex-row items-center">
          <div class="flex-1">
            <h2 class="card-title">A New Ethernet Cable</h2>
            <p>We can pull Ethernet cables for your home or office setup.</p>
            <p>Typically: 2 hours</p>
          </div>
          <!--
          {#if imageLoaded[4]}
            <img src={images[4].src} alt={images[4].alt} width={images[4].width} height={images[4].height} class="ml-4" />
          {/if}
          -->
        </div>
      </div>
    ...
    <div class="cta bg-base-200 flex justify-between items-center">
      <div>
        <PopupForm buttonLabel={"Ready to Get Started?"} />
        <div class="divider mb-5 bg-base-200"/>
      </div>
      <div>
        {#if imageLoaded[4]}
