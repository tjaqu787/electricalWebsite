<script>
  ...
  <div class="container mx-auto p-6">
    ...
    <!-- Content -->
    <h2 class="text-2xl font-semibold mb-2">Common Issues We See</h2>
    <p class="mb-4">The three most common issues we see are lights not working, broken plugs, and breakers tripping.</p>
